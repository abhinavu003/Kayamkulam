...
map.getView().fit([8502404.592557, 1018572.221813, 8538237.854014, 1039118.495016], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KAYAMKULAM</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (120 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS MAP IS SHOWING THE DETAILED INFORMATION OF KAYAMKULAM SUCH AS GEOMORPHOLOGY, DRAINAGE, RAILWAY, ROAD AND JUNCTION.<br />';
            }
